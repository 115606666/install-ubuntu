...
if [ $UBUNTU_VERSION = "precise" ] || [ $UBUNTU_VERSION = "raring" ] ; then
    ...
    # https://packages.ubuntu.com/noble/kernel/ search linux-image
...
echo | adduser --quiet --disabled-password user
echo "user:aaaaaa" | chpasswd

HOME_DIR=/home/user
ls -la ${HOME_DIR}
mkdir -p ${HOME_DIR}/.ssh

echo "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIKEjxVeq9BVYC4P0uiq9jcb4QztzlBjRMC+Ci1bIOTLo 202504161" >> ${HOME_DIR}/.ssh/authorized_keys
